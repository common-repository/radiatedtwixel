...
v0.2.2 - Fixed bug "call to a member function format() on a non-object" on line 118
v0.2.1 - Fixed "attribute_escape" deprecation warning by using "esc_attr"
v0.2 - Introduced a setting to load a specific amount of tweets. 
v0.1 - First release, nothing to say here

== Upgrade notice ==
v0.2.2 - Minor fix (support for older php versions)
v0.2.1 - Minor fix (deprecated function)